...
HD_PWD='D:/Xilinx/reconfig/wordle_fsm/wordle_fsm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Wordle_Matcher_HDL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Wordle_Matcher_HDL.tcl
