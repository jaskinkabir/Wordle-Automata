...
HD_PWD='D:/Xilinx/reconfig/wordle_fsm/wordle_fsm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Wordle_Matcher_HDL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Wordle_Matcher_HDL.tcl -notrace
