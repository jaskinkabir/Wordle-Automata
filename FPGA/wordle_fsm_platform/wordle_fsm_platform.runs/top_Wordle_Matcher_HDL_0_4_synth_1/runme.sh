...
HD_PWD='D:/Xilinx/reconfig/wordle_fsm_platform/wordle_fsm_platform.runs/top_Wordle_Matcher_HDL_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Wordle_Matcher_HDL_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_Wordle_Matcher_HDL_0_4.tcl
