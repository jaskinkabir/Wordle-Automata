...
HD_PWD='D:/Xilinx/reconfig/wordle_fsm_platform/wordle_fsm_platform.runs/top_rst_ps7_0_100M_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rst_ps7_0_100M_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_rst_ps7_0_100M_3.tcl
