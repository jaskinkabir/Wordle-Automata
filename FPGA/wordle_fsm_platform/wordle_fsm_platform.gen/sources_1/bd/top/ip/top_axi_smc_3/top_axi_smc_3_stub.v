...
// Command     : write_verilog -force -mode synth_stub -rename_top top_axi_smc_3 -prefix
//               top_axi_smc_3_ top_axi_smc_3_stub.v
...
(* CHECK_LICENSE_TYPE = "top_axi_smc_3,bd_b57a,{}" *) (* CORE_GENERATION_INFO = "top_axi_smc_3,bd_b57a,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=25,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_b57a,Vivado 2024.2" *) 
module top_axi_smc_3(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
