...
#
# Script generated by Vivado on Mon Apr 28 00:29:31 -0400 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L xlconstant_v1_1_9 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top xil_defaultlib.top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top -key {Behavioral:sim_1:Functional:top} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_b57a.protoinst" -protoinst "protoinst_files/top.protoinst" -log simulate.log
}
